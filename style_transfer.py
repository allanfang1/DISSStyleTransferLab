...
if __name__ == '__main__':
    ...
    ########################## DISPLAY IMAGE#########################################################""
    content = load_image('/mnt/d/Desktop/reading/M2/IML/tp2/montagne_small.jpg').to(device)
    style = load_image('/mnt/d/Desktop/reading/M2/IML/tp2/peinture1_small.jpg', shape=content.shape[-2:]).to(device)
    ...
    for i in range(20000):
        ...
        for layer in style_layers:
            style_loss += torch.mean((gram_matrix(target_features[layer]) - style_grams[layer])**2)
        ...
        if  i % show_every == 0:
            ...
            plt.imsave('output.png', im_convert(target))
            print("save %d" % i)
